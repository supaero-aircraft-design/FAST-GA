...
write_xdsm(CONFIGURATION_FILE, XDSM_FILE, overwrite=True, depth = -1) #depth = -1 to reach as far into the sub-modules as we can go, stopping before the variables themselves
