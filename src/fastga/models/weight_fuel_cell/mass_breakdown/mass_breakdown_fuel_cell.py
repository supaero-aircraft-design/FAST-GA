...
@RegisterSubmodel(SUBMODEL_MASS_BREAKDOWN, "fastga.submodel.weight.mass_breakdown.fuel_cell")
...
@RegisterSubmodel(SUBMODEL_OWE, "fastga.submodel.weight.mass.owe.fuel_cell")
