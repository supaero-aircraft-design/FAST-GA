...
def test_OMBasicHEEngineComponent():
    ...
    ivc = om.IndepVarComp()
    ivc.add_output("data:propulsion:hybrid_powertrain:motor:max_power", 130000, units="W")
    ...
    ivc.add_output("data:geometry:hybrid_powertrain:cables:length", 10.0, units="m")
