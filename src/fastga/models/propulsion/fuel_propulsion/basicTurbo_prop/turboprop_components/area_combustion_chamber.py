...
class A41(om.ExplicitComponent):
    ...
    def compute_partials(self, inputs, partials, discrete_inputs=None):
        ...
        partials["data:propulsion:turboprop:section:41", "air_mass_flow"] = (
            (1 + fuel_air_ratio - pressurization_bleed_ratio - compressor_bleed_ratio)
            * np.sqrt(total_temperature_41 * r_g)
            / total_pressure_4
            / np.sqrt(gamma_41)
        ...
        partials["data:propulsion:turboprop:section:41", "total_pressure_4"] = -(
            airflow_design
            * (1 + fuel_air_ratio - pressurization_bleed_ratio - compressor_bleed_ratio)
            * np.sqrt(total_temperature_41 * r_g)
        ...
        partials["data:propulsion:turboprop:section:41", "fuel_air_ratio"] = (
            airflow_design
            * np.sqrt(total_temperature_41 * r_g)
            / total_pressure_4
            / np.sqrt(gamma_41)
        ...
        partials["data:propulsion:turboprop:section:41", "compressor_bleed_ratio"] = -(
            airflow_design
            * np.sqrt(total_temperature_41 * r_g)
            / total_pressure_4
            / np.sqrt(gamma_41)
        ...
        partials["data:propulsion:turboprop:section:41", "pressurization_bleed_ratio"] = -(
            airflow_design
            * np.sqrt(total_temperature_41 * r_g)
            / total_pressure_4
            / np.sqrt(gamma_41)
