...
def test_compute_flight_points():
    ...
    engine = BasicICEngine(130000.0, 2400.0, 81.0, 1.0, 4.0, 1.0,
                           SPEED, THRUST_SL, THRUST_SL_LIMIT, EFFICIENCY_SL,
                           SPEED, THRUST_CL, THRUST_CL_LIMIT, EFFICIENCY_CL)  # load a 4-strokes 130kW gasoline engine
...
def test_engine_weight():
    ...
    _50kw_engine = BasicICEngine(50000.0, 2400.0, 81.0, 1.0, 4.0, 1.0,
                           SPEED, THRUST_SL, THRUST_SL_LIMIT, EFFICIENCY_SL,
                           SPEED, THRUST_CL, THRUST_CL_LIMIT, EFFICIENCY_CL)
...
def test_sfc_at_max_thrust():
    ...
    _50kw_engine = BasicICEngine(50000.0, 2400.0, 81.0, 1.0, 4.0, 1.0,
                           SPEED, THRUST_SL, THRUST_SL_LIMIT, EFFICIENCY_SL,
                           SPEED, THRUST_CL, THRUST_CL_LIMIT, EFFICIENCY_CL)
    atm = Atmosphere([0., 4000., 8000.], altitude_in_feet=True)
