...
@RegisterPropulsion("fastga.wrapper.propulsion.basic_turboprop")
class OMBasicTurboPropWrapper(IOMPropulsionWrapper):
    """
    Wrapper class of for basic turbopropeller model.
    ...
    def get_model(inputs) -> IPropulsion:
        ...
        :return: an :class:`BasicTurboPropEngine` instance
        """
        engine_params = {
        ...
        return BasicTurboPropEngine(**engine_params)
...
class OMBasicTurboPropEngineComponent(BaseOMPropulsionComponent):
    """
    Parametric engine model as OpenMDAO component
    See :class:`BasicTurboPropEngine` for more information.
    """
    ...
    @staticmethod
    def get_wrapper() -> OMBasicTurboPropWrapper:
        return OMBasicTurboPropWrapper()
