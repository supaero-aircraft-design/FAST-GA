...
from ..openmdao import OMBasicTurboPropEngineComponent
...
def test_OMBasicTurboPropEngineComponent():
    """ Tests ManualBasicICEngine component """
    # Same test as in test_basicIC_engine.test_compute_flight_points
    engine = OMBasicTurboPropEngineComponent(flight_point_count=(2, 5))
