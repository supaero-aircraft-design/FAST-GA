...
class ComputeStaticMargin(om.Group):
    ...
    def setup(self):
        ...
        self.add_subsystem(
            "stick_fixed_static_margin", ComputeStaticMarginStickFixed(), promotes=["*"]
        )
        self.add_subsystem(
            "stick_free_static_margin", ComputeStaticMarginStickFree(), promotes=["*"]
        )


class ComputeStaticMarginStickFixed(om.ExplicitComponent):
    """
    Computation of static margin (stick fixed) i.e. difference between CG ratio and neutral
...
class ComputeStaticMarginStickFree(om.ExplicitComponent):
    """
    Computation of static margin (stick free) i.e. difference between CG ratio and neutral
    point as function of MAC.
    """
