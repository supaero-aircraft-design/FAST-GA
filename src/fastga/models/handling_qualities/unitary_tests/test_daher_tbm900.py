...
def test_update_vt_area():
    ...
    # the dummy engine is not recognized as an ICE engine the last constraints applies even
    # though it shouldn't
...
def test_compute_to_rotation_limit():
    """
    Tests the computation of the forward most possible CG location for the TO rotation in case
    HTP area is fixed.
    """
...
def test_balked_landing_limit():
    """
    Tests the computation of the forward most possible CG location for a balked landing in case
     HTP area is fixed.
    """
