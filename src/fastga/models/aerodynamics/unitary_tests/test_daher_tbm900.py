...
def test_cn_r_wing():
    ...
    yaw_moment_yaw_rate_wing(
        XML_FILE, cn_r_wing_low_speed_=-0.05036267, cn_r_wing_cruise_=-0.01767073
    )
...
def test_cn_r_aircraft():
    ...
    yaw_moment_yaw_rate_aircraft(XML_FILE, cn_r_low_speed_=-0.18550409, cn_r_cruise_=-0.15594427)
