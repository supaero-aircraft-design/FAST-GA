...
def test_cl_r_wing():
    ...
    roll_moment_yaw_rate_wing(
        XML_FILE, cl_r_wing_low_speed_=0.13883853, cl_r_wing_cruise_=0.07343175
    )
...
def test_cl_r_aircraft():
    ...
    roll_moment_yaw_rate_aircraft(XML_FILE, cl_r_low_speed_=0.19227174, cl_r_cruise_=0.13960188)
...
def test_cn_delta_a_aircraft():
    ...
    yaw_moment_aileron(XML_FILE, cn_delta_a_low_speed_=-0.01884442, cn_delta_a_cruise_=-0.01266857)
...
def test_cn_r_wing():
    ...
    yaw_moment_yaw_rate_wing(
        XML_FILE, cn_r_wing_low_speed_=-0.00687338, cn_r_wing_cruise_=-0.00348916
    )
...
def test_cn_r_aircraft():
    ...
    yaw_moment_yaw_rate_aircraft(XML_FILE, cn_r_low_speed_=-0.14201479, cn_r_cruise_=-0.1417627)
