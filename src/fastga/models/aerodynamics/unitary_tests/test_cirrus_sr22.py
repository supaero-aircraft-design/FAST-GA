...
def test_3d_hinge_moment():
    """Tests tail hinge-moments."""
    hinge_moment_3d(XML_FILE, ch_alpha=-0.2594, ch_delta=-0.6234)


def test_all_hinge_moment():
    """Tests tail hinge-moments full computation."""
    hinge_moments(XML_FILE, ch_alpha=-0.2594, ch_delta=-0.6234)
...
def test_cm_alpha_fus():
    """Tests cy delta of the rudder."""
    cm_alpha_fus(XML_FILE, cm_alpha_fus_=-0.71870611)
...
def test_cl_r_wing():
    ...
    roll_moment_yaw_rate_wing(
        XML_FILE, cl_r_wing_low_speed_=0.14091384, cl_r_wing_cruise_=0.05495404
    )
...
def test_cl_r_aircraft():
    ...
    roll_moment_yaw_rate_aircraft(XML_FILE, cl_r_low_speed_=0.17562288, cl_r_cruise_=0.09537707)


def test_cl_delta_a_aircraft():
    """Test roll authority of the aileron."""
    roll_authority_aileron(XML_FILE, cl_delta_a_low_speed_=0.21275, cl_delta_a_cruise_=0.2181)
...
def test_cn_delta_a_aircraft():
    ...
    yaw_moment_aileron(XML_FILE, cn_delta_a_low_speed_=-0.01718897, cn_delta_a_cruise_=-0.00679771)
...
def test_cn_r_wing():
    ...
    yaw_moment_yaw_rate_wing(
        XML_FILE, cn_r_wing_low_speed_=-0.00639411, cn_r_wing_cruise_=-0.00239631
    )
...
def test_cn_r_aircraft():
    ...
    yaw_moment_yaw_rate_aircraft(XML_FILE, cn_r_low_speed_=-0.09491686, cn_r_cruise_=-0.08748969)
