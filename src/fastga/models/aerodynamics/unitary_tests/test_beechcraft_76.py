...
def test_cl_r_wing():
    ...
    roll_moment_yaw_rate_wing(
        XML_FILE, cl_r_wing_low_speed_=0.11450596, cl_r_wing_cruise_=0.02478482
    )
...
def test_cl_r_aircraft():
    ...
    roll_moment_yaw_rate_aircraft(XML_FILE, cl_r_low_speed_=0.14390746, cl_r_cruise_=0.05998969)
...
def test_cn_r_wing():
    ...
    yaw_moment_yaw_rate_wing(
        XML_FILE, cn_r_wing_low_speed_=-0.00771545, cn_r_wing_cruise_=-0.00311809
    )
...
def test_cn_r_aircraft():
    ...
    yaw_moment_yaw_rate_aircraft(XML_FILE, cn_r_low_speed_=-0.09565462, cn_r_cruise_=-0.08816559)
