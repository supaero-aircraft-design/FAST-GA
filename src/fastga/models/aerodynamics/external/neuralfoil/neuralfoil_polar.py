...
class NeuralfoilPolar(ExternalCodeComp):
    ...
    def compute(self, inputs, outputs):
        ...
        if interpolated_result is None:
            ...
            nf.get_aero_from_dat_file(airfoil_path,alpha=alpha,Re=reynolds)
            ...
            ) = self._run_neuralfoil(inputs, outputs, reynolds)
    ...
    def _run_neuralfoil(self, inputs, outputs, reynolds):
        """
