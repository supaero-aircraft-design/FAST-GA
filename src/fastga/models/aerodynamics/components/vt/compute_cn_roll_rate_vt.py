...
class ComputeCnRollRateVerticalTail(om.ExplicitComponent):
    ...
    def setup(self):
        ...
        self.add_output("data:aerodynamics:vertical_tail:" + ls_tag + ":Cn_p", units="rad**-1")
    ...
    def compute(self, inputs, outputs, discrete_inputs=None, discrete_outputs=None):
        ...
        outputs["data:aerodynamics:vertical_tail:" + ls_tag + ":Cn_p"] = (
            -2.0
            * cy_beta_vt
    ...
    def compute_partials(self, inputs, partials, discrete_inputs=None):
        ...
        partials[
            "data:aerodynamics:vertical_tail:" + ls_tag + ":Cn_p",
