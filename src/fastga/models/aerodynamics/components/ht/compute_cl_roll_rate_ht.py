...
class ComputeClRollRateHorizontalTail(FigureDigitization):
    """
    Class to compute the contribution of the horizontal tail to the roll moment coefficient due to
    roll rate (roll damping). Depends on the lift coefficient of the horizontal tail, hence on the
    reference angle of attack, so the same remark as in ..compute_cy_yaw_rate.py holds.
