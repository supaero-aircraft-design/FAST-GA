"""
Python module for wing lift effect of Cn_r calculation, part of the aerodynamic
...
#  but WITHOUT ANY Waspect_ratioRANTY; without even the implied warranty of
#  MERCHANTABILITY or FITNESS FOR A Paspect_ratioTICULaspect_ratio PURPOSE.  See the
