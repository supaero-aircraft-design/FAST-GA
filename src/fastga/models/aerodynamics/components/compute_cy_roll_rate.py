...
@oad.RegisterSubmodel(SUBMODEL_CY_P, "fastga.submodel.aerodynamics.aircraft.cy_roll_rate.legacy")
class ComputeCyRollRateAircraft(om.ExplicitComponent):
    ...
    :cite:`roskampart6:1990` are used, meaning that, for the derivative with respect to yaw and
