...
@oad.RegisterSubmodel(SUBMODEL_CN_RUDDER, "fastga.submodel.aerodynamics.rudder.yaw_moment.legacy")
class ComputeCnDeltaRudder(om.ExplicitComponent):
    ...
    the wing. The convention from :cite:`roskampart6:1990` are used, meaning that for lateral
