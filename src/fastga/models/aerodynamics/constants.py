...
LIMIT_MACH_COMPRESSIBILITY_EFFECT = 0.2
MIN_LENGTH_AOA_ARRAY = 2
MIN_AOA_RANGE_COVERED = 0.4
MAX_DEVIATION_ACCEPTED = 0.3
MAX_RELATIVE_THICKNESS = 0.5
MIN_COORDINATE_NUMBER = 3
Y_COORDINATE_PRECISION = 1e-8
X_COORDINATE_PRECISION = 1e-6
