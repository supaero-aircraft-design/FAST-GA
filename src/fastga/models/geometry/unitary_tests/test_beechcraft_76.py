...
def test_compute_fuselage_cabin_sizing_fd():
    ...
    assert luggage_length_rear == pytest.approx(0.696, abs=1e-3)
...
def test_geometry_landing_gears():
    ...
    assert lg_y == pytest.approx(1.46933, abs=1e-3)
...
def test_wing_maximum_fuel_weight():
    ...
    assert max_fuel_weight == pytest.approx(396.744, abs=1e-3)
