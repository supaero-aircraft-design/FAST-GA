...
class ComputeWingGeometry(Group):
    ...
    def setup(self):
        ...
        self.add_subsystem(
            "wing_y_root",
            oad.RegisterSubmodel.get_submodel(SUBMODEL_WING_Y_ROOT),
            promotes=["*"],
        )
        self.add_subsystem(
            "wing_y_kink",
            oad.RegisterSubmodel.get_submodel(SUBMODEL_WING_Y_KINK),
            promotes=["*"],
        )
        self.add_subsystem(
            "wing_y_tip",
            oad.RegisterSubmodel.get_submodel(SUBMODEL_WING_Y_TIP),
            promotes=["*"],
        )
        self.add_subsystem(
