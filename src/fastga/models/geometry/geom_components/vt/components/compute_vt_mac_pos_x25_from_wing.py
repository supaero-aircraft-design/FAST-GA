...
from ..constants import SUBMODEL_VT_POSITION_FL_X25_W


@oad.RegisterSubmodel(
    SUBMODEL_VT_POSITION_FL_X25_W,
    "fastga.submodel.geometry.vertical_tail.position.fl.x25_wing.legacy",
)
class ComputeVTMacX25WFL(om.ExplicitComponent):
    """
