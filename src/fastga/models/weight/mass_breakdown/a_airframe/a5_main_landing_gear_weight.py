...
from .constants import SUBMODEL_MAIN_LANDING_GEAR_MASS

oad.RegisterSubmodel.active_models[
    SUBMODEL_MAIN_LANDING_GEAR_MASS
] = "fastga.submodel.weight.mass.airframe.main_landing_gear.legacy"


@oad.RegisterSubmodel(
    SUBMODEL_MAIN_LANDING_GEAR_MASS, "fastga.submodel.weight.mass.airframe.main_landing_gear.legacy"
)
class ComputeMainLandingGearWeight(om.ExplicitComponent):
    """
