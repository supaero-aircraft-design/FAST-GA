...
def test_compute_systems_weight():
    """Tests systems weight computation from sample XML data."""
...
def test_compute_systems_weight_group():
    """Tests systems weight computation as a group from sample XML data."""
...
def test_compute_furniture_weight():
    """Tests furniture weight computation from sample XML data."""
...
def test_compute_furniture_weight_group():
    """Tests furniture weight computation as a group from sample XML data."""
...
def test_evaluate_mlw():
    ...
    assert mlw == pytest.approx(3207, abs=1)
