...
def test_compute_airframe_weight():
    ...
    ivc.add_output("data:weight:airframe:wing:mass", val=174.95, units="kg")
    ...
    assert weight_a == pytest.approx(473.06, abs=1e-2)
...
def test_compute_propulsion_weight():
    ...
    assert weight_b == pytest.approx(408.89, abs=1e-2)
...
def test_compute_systems_weight():
    ...
    assert weight_b == pytest.approx(179.37, abs=1e-2)
...
def test_compute_furniture_weight():
    ...
    assert weight_b == pytest.approx(51.79, abs=1e-2)
...
def test_evaluate_owe():
    ...
    assert oew == pytest.approx(1118, abs=1)
...
def test_update_mtow():
    ...
    assert mzfw == pytest.approx(1747, abs=1)
