...
def test_evaluate_owe():
    ...
    assert oew == pytest.approx(1122.34, abs=1)
...
def test_loop_compute_owe():
    ...
    oew = mass_computation.get_val("data:weight:aircraft:OWE", units="kg")
    assert oew == pytest.approx(1125.36, abs=1)
