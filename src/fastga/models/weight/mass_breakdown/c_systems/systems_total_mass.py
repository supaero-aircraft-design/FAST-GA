...
class ComputeSystemMass(om.ExplicitComponent):
    ...
    def setup(self):
        ...
        self.add_input("data:weight:systems:life_support:insulation:mass", val=0.0, units="kg")
        self.add_input(
            "data:weight:systems:life_support:internal_lighting:mass", val=0.0, units="kg"
        )
        self.add_input(
            "data:weight:systems:life_support:seat_installation:mass", val=0.0, units="kg"
        )
        self.add_input("data:weight:systems:life_support:security_kits:mass", val=0.0, units="kg")
