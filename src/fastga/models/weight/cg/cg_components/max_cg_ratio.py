...
class ComputeMaxMinCGRatio(om.ExplicitComponent):
    ...
    def setup(self):
        self.add_input("data:weight:aircraft:CG:flight_condition:max:MAC_position", val=np.nan, units="unitless")
        self.add_input("data:weight:aircraft:CG:flight_condition:min:MAC_position", val=np.nan, units="unitless")
        self.add_input("data:weight:aircraft:CG:ground_condition:max:MAC_position", val=np.nan, units="unitless")
        self.add_input("data:weight:aircraft:CG:ground_condition:min:MAC_position", val=np.nan, units="unitless")
