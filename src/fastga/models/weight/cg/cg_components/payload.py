...
class ComputePayloadCG(ExplicitComponent):
    ...
    def setup(self):
        ...
        self.add_input("data:geometry:fuselage:luggage_length_front", val=np.nan, units="m")
    ...
    def compute(self, inputs, outputs, discrete_inputs=None, discrete_outputs=None):
        ...
        l_lug_front = inputs["data:geometry:fuselage:luggage_length_front"]
        l_lug_rear = inputs["data:geometry:fuselage:luggage_length_rear"]
