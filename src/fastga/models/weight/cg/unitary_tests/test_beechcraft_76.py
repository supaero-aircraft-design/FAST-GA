...
def test_compute_cg_main_landing_gear():
    ...
    assert x_cg_a51 == pytest.approx(4.29, abs=1e-2)
...
def test_compute_aft_cg_ratio_mac():
...
def test_compute_aft_cg_x():
    ...
    assert aft_cg_x == pytest.approx(3.629, abs=1e-3)
...
def test_compute_fwd_cg_x():
    ...
    assert fwd_cg_x == pytest.approx(3.314, abs=1e-3)
...
def test_compute_aircraft_empty_cg_z():
    ...
    assert cg_z == pytest.approx(1.05, abs=1e-3)
...
def test_compute_engine_cg_z():
    ...
    assert engine_cg_z == pytest.approx(1.195, abs=1e-2)
