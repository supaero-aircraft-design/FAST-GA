...
class Disc1(om.ExplicitComponent):
    ...
    def setup(self):
        self.add_input("data:geometry:variable_1", val=np.nan, desc="")  # NaN as default for testing connexion check
        self.add_input("data:geometry:variable_2", val=[5, 2], desc="", units="m**2")  # for testing non-None units
